...
},{"_process":5,"remotify-example-client":7}],2:[function(require,module,exports){
'use strict';
...
},{"whatwg-fetch":8}],5:[function(require,module,exports){
...
},{"easy-json-rpc":2,"isomorphic-fetch":4}],7:[function(require,module,exports){
"use strict";
...
module.exports = function(options) {
  ...
  return {
    "random": client.createFunction("random"),
    "subtract": client.createFunction("subtract"),
    "sleep": client.createFunction("sleep"),
    "boolean": true,
    "number": 123.45,
    "string": "Hello",
    "object": {"a":1,"b":2},
    "date": "2017-02-06T07:11:51.968Z"
  };
};

},{"remotify-client":6}],8:[function(require,module,exports){
(function(self) {
  'use strict';
