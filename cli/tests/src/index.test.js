...
describe('CLI', () => {
  ...
  test('can get a property', async () => {
    ...
    await expect(runExpression('invalidProperty', {directory: personInstanceDirectory})).rejects.toBeInstanceOf(Error);
  });
  ...
  test('can run a method', async () => {
    ...
    await expect(runExpression('formatGreetingMethod Hi extraArgument', {directory: personInstanceDirectory})).rejects.toBeInstanceOf(Error);
